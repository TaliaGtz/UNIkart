<?php
    ...
    $consulta  = mysqli_query($conexion,'CALL sp_4Var(9, "'.$IDUser.'");');
    while(mysqli_next_result($conexion)){;}
...
?>
    ...
    <article id="" class="articles" style="display:block;">
        <img src="../ExtraDocs/Menu.png" height="70px" width="70px" id="image" class="files">
        <div class="contDiv">
            <h2><?php echo $fila['Nombre'] ?></h2>
            <label> Lista <?php echo $fila['Privacidad'] ?></label>
