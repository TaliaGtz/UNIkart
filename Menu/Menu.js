...
$("#Plus").click(function(){
    ...
    $(function(){ $("#mc").load("../Menu/categorias.php"); }),
    'Cerrar');
});
...
function Plus(titulo, contenido, idioma) {
    ...
    var ModalData = document.getElementById("modal");
    var boton = "";
    ModalData.innerHTML = '<div id="modal-back"></div><div class="newModal"><div id="modal-new" class="modal-new"><h3>'
    + titulo +'</h3><form id="mc" class="mc"  method="POST" action="../Menu/AddProd.php">'
